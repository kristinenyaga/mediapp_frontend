...
const Footer = () => {
  return (
    <footer className="relative bg-white text-gray-800 py-12 mt-20">
      ...
      <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 sm:grid-cols-3 gap-12 text-center sm:text-left relative">
        <div className="flex flex-col gap-4">
          <h2 className="text-xl font-semibold text-[#6C4DE6]">About Us</h2>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-xl font-semibold text-[#6C4DE6]">Quick Links</h2>
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-xl font-semibold text-[#6C4DE6]">Contact Us</h2>
